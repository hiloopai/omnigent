...
def _list_provider_names() -> list[str]:
    ...
    """
    return sorted([
        "ai21", "aleph_alpha", "amazon_nova", "anthropic", "anyscale",
        "azure", "azure_ai", "azure_text", "bedrock", "bedrock_mantle",
        "cerebras", "cloudflare", "codestral", "cohere", "cohere_chat",
        "dashscope", "databricks", "deepinfra", "deepseek",
        "featherless_ai", "fireworks_ai", "friendliai", "gemini",
        "gigachat", "github_copilot", "gmi", "gradient_ai", "groq",
        "heroku", "hyperbolic", "lambda_ai", "lemonade", "llamagate",
        "meta_llama", "minimax", "mistral", "moonshot", "morph",
        "nebius", "nlp_cloud", "novita", "nscale", "oci", "ollama",
        "openai", "openrouter", "ovhcloud", "palm", "perplexity",
        "publicai", "replicate", "sagemaker", "sambanova", "sarvam",
        "snowflake", "text-completion-codestral", "text-completion-openai",
        "together_ai", "v0", "vercel_ai_gateway", "vertex_ai",
        "volcengine", "voyage", "wandb", "watsonx", "xai", "zai",
    ])
